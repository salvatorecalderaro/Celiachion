...
def split_dataset(till_survey_dataset_file, till_poct_dataset_file, till_blood_tests_dataset_file, complete_dataset_file):
    ...
    till_survey_dataframe.to_csv(resource_path + till_survey_dataset_file, index=False)
    ...
    till_poct_dataframe.to_csv(resource_path + till_poct_dataset_file, index=False)
    ...
    till_blood_tests_dataframe.to_csv(resource_path + till_blood_tests_dataset_file, index=False, na_rep=np.nan)
    # complete dataset
